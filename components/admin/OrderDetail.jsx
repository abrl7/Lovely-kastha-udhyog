    ...
    <div className="bg-white border border-walnut/15 rounded-sm p-6 h-fit sticky top-24">
      ...
      <div className="grid grid-cols-2 gap-4 mb-5 pb-5 border-b border-walnut/10">
        ...
        <div>
          ...
          <a
            href={`https://wa.me/${order.customerPhone?.replace(/[^0-9]/g, "").replace(/^0/, "977")}?text=${encodeURIComponent(
              `Hello ${order.customerName}, this is regarding your order ${order.orderCode} at Lovely Kastha Udhog.`
            )}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-green-700 border border-green-300 rounded-sm px-2.5 py-1 hover:bg-green-50 transition-colors"
          >
            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M12.004 2C6.477 2 2 6.484 2 12.017c0 1.868.503 3.614 1.38 5.125L2 22l4.985-1.366A9.953 9.953 0 0012.004 22C17.522 22 22 17.516 22 11.983 22 6.477 17.522 2 12.004 2zm0 18.005a8.005 8.005 0 01-4.099-1.132l-.292-.177-3.016.826.849-3.036-.192-.307a8.004 8.004 0 01-1.25-4.179c0-4.424 3.585-8.02 7.994-8.02 4.416 0 8.006 3.596 8.006 8.02 0 4.42-3.59 8.005-8 8.005z"/>
            </svg>
            Reply on WhatsApp
          </a>
        </div>
